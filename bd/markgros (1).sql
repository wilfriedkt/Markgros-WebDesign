...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 25 oct. 2024 à 13:41
...
(2, '../img/uploads/preuve de la propriété du projet_pr', 'soulier', 'trgft', 3, 4),
(3, '../img/uploads/preuve de la propriété du projet_pr', 'soulier', 'ytrbgvz', 4, 5),
(4, '../img/uploads/1.jpg', 'eyukiujhfgvc', 'thyjtufgdvsg', 5, 4),
(5, '../img/uploads/fervapeur.jpg', 'FER REPASSE', 'UIYTRVC', 3, 4),
(6, '../img/uploads/1 (8).jpg', 'PRODUIT ', 'CGHJKKUHGYFTGVHJH', 20, 10),
(7, '../img/uploads/refrig.jpg', 'frigo', 'fhjhkgfgchbjnkj', 20000, 7);
